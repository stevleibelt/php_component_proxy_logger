 ...
 * @since 2013-08-26
 */
interface ProxyLoggerInterface extends LoggerInterface, LogRequestFactoryDependInterface, ProxyEventFactoryDependInterface, EventDispatcherDependInterface
{
    /**
